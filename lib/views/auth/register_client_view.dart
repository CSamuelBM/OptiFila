...
class _State extends State<RegisterClientView> {
  ...
  Future<void> _submit() async {
    ...
    final ok=await AppControllers.auth.registerClient(name:_name.text.trim(),email:_email.text.trim(),password:_password.text);
    if(!mounted)return;
    ...
    body:SafeArea(child:Column(children:[
      ...
      Expanded(child:Container(
        ...
        child:SingleChildScrollView(child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
          ...
          const SizedBox(height:14),
          _label('Contraseña'),
          TextField(controller:_password,obscureText:_obscure,decoration:InputDecoration(hintText:'••••••••',
